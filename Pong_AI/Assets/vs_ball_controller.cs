...
public class vs_ball_controller : MonoBehaviour
{
    public Rigidbody rb;
    ...
    private d_agent_vs d_agentscript;//change to O agent for O training
    private o_agent_vs o_agentscript;//
...

    {
        ...
        d_agentscript = d_agent.GetComponent<d_agent_vs>();
        o_agentscript = o_agent.GetComponent<o_agent_vs>();
    }
